...
public class ArmsUtils {
    ...
    public static void configSwipeLayout(final SwipeRefreshLayout swipeRefreshLayout, @ColorRes int... colorResIds) {
    ...
    public static String listToString(List<String> stringList, String index) {
        if (stringList == null) {
            return "";
        }
    ...
    public static boolean contais(String str, String subStr) {
