...
import com.nuogao.titlebar.R;
import com.nuogao.titlebar.statusbar.OSUtils;
import com.nuogao.titlebar.statusbar.StatusBarUtils;
import com.nuogao.titlebar.utils.KeyboardConflictCompat;
import com.nuogao.titlebar.utils.ScreenUtils;
...
//            }
    ...
    public void onClick(View v) {
        ...
        if (v.equals(llMainCenter) && doubleClickListener != null) {
            ...
            listener.onClicked(v, ACTION_RIGHT_VIEW, null);
        }
    }
    ...
    public static final int ACTION_RIGHT_VIEW = 10; // 右侧布局被点击
