 ...
 */
public class PayFragment extends VpFragment implements OnRefreshListener, OnLoadMoreListener {
    ...
    protected void onFragmentVisibleChange(boolean isVisible) {
        if (isVisible) {//显示界面
            ...
            myObserver = new MyObserver<OrderListBean>(getActivity(), true) {
                ...
                public void onSuccess(OrderListBean result) {
                    if (result.getData() != null) {
                        adapter = new OrderAdapter(getActivity(), R.layout.item_order, result.getData(),"1",getActivity());
            ...
            RetrofitUtils.getApiUrl().orderList(DataHelper.getIntergerSF(getActivity(), "userType") + "", "1", page + "", "10", DataHelper.getStringSF(getActivity(), "token"))
