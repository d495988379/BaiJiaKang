 ...
 */
public abstract class MyImgObserver extends BaseImgObserver {
    ...
    public MyImgObserver(Context context, Boolean showDialog) {
        mContext = context;
        mShowDialog = showDialog;
    }

    public MyImgObserver(Context context) {
        this(context, true);
    }
