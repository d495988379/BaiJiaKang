 ...
 */
public class SearchAdapter extends EmptyAdapter<CommodityListBean.RowsBean> {

    public SearchAdapter(Context context, int layoutResId, List<CommodityListBean.RowsBean> datas) {
        super(context, layoutResId, datas);
    }

    @Override
    protected void convert(BaseEmptyViewHolder viewHolder, CommodityListBean.RowsBean item) {
