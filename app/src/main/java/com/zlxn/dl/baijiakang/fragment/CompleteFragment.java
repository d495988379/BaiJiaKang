 ...
 * @name BaiJiaKang
 * @class describe
 * @time 2020/11/13 17:51
 */
public class CompleteFragment extends VpFragment implements OnRefreshListener, OnLoadMoreListener {
    ...
    private RelativeLayout swipeRel;
    ...
    protected void onFragmentVisibleChange(boolean isVisible) {
        if (isVisible) {//显示界面
            ...
            myObserver = new MyObserver<OrderListBean>(getActivity(), true) {
                ...
                public void onSuccess(OrderListBean result) {
                    if (result.getData() != null) {
                        adapter = new OrderAdapter(getActivity(), R.layout.item_order, result.getData(),"5",getActivity());
            ...
            RetrofitUtils.getApiUrl().orderList(DataHelper.getIntergerSF(getActivity(), "userType") + "", "5", page + "", "10", DataHelper.getStringSF(getActivity(), "token"))
