...
public class PasswordView extends RelativeLayout {
    ...
    public void allCancel(){
        ...
        imgList[0].setVisibility(View.INVISIBLE);
        imgList[1].setVisibility(View.INVISIBLE);
        imgList[2].setVisibility(View.INVISIBLE);
        imgList[3].setVisibility(View.INVISIBLE);
        imgList[4].setVisibility(View.INVISIBLE);
        imgList[5].setVisibility(View.INVISIBLE);
